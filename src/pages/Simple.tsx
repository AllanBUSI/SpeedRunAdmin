                        ...
                        <Card className="card-border">
                            <Card.Body className="card-border">
                                <Nav>
                                    ...
                                    <Nav.Item>
                                        <div onClick={simple} className="hover-color"><Nav.Link style={{color: "beige"}} className="active">Création simple</Nav.Link></div>
                                    </Nav.Item>
                                    <Nav.Item>
                ...
                <Form>
                    <div className="row">
                        <div className="size-card-12 row col-xs-12 card-speedrun size-block-principal">
                            <h2 className="col-12">Création simple de publicités</h2>
                                    ...
                                    <Card.Body className="card-border row">
                                        <div className="col-12">
                                            <div className="col-12 row">
                                                ...
                                                <p className="text-center text-muted">Le prix est calculer par rapport au nombre d'utilisateur + des frais de gestion de 100 € : 100 + 0.50 * 556</p>
                                            </div>
