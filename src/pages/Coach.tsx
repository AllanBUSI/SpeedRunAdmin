                ...
                <div className="size-card-12 col-xs-12 card-speedrun">
                    <Card className="card-border">
                        <Card.Body className="card-border">
                            <Nav>
                                <Nav.Item>
                                    <div className="hover-color active" onClick={coach}><Nav.Link style={{color: "beige"}}>Voir les coachs</Nav.Link></div>
                                </Nav.Item>
                                <Nav.Item>
                                    <div className="hover-color" onClick={validate}><Nav.Link style={{color: "beige"}}>Coachs en cours d'inscritpion</Nav.Link></div>
                                </Nav.Item>
                            </Nav>
                        </Card.Body>
                    </Card>
